...
//!
//! This module provides helper functions for edge routing:
//! - `route_back_edge`: Routes cycle edges through the appropriate gutter
//! - `center_x`, `center_y`: Calculate visual center of nodes
//!
//! Note: Main edge routing (divergent/convergent) is in edge_unified.rs
...
/// Route a back-edge (cycle) through the appropriate gutter.
///
...
mod tests {
    ...
    #[test]
    fn back_edge_routes_through_gutter_td() {
        ...
        route_back_edge(&src, &target, &mut canvas, &chars, Direction::TD);
