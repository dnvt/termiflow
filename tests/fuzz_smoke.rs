...
fn lcg_next(state: &mut u64) -> u64 {
    ...
    // Constants from Numerical Recipes; good enough for smoke coverage.
...
fn fuzz_smoke_random_json_graphs_do_not_panic() {
    for seed in 0_u64..80 {
        ...
        // Keep graphs modest and mostly acyclic to avoid pathological layout blowups in smoke tests.
        ...
        for e in 0..edge_count {
            ...
            // Generate forward edges only (DAG-ish): from < to.
        ...
        // Occasionally include a single subgraph to exercise portals/borders.
        ...
        for compact in [false, true] {
            ...
            // Basic sanity checks: non-empty, bounded size to avoid accidental blowups.
            assert!(
