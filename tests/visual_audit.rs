...
const CURATED_FIXTURES: &[&str] = &[
    ...
    "tests/fixtures/inputs/subgraph_nested_td.md",
    "tests/fixtures/inputs/subgraph_nested_lr.md",
    "tests/fixtures/inputs/subgraph_nested_bt.md",
    ...
    "tests/fixtures/inputs/collision_sibling_subgraphs_lr.md",
    "tests/fixtures/inputs/collision_sibling_subgraphs_rl.md",
    ...
    "tests/fixtures/inputs/unicode_emoji_td.md",
    "tests/fixtures/inputs/unicode_cjk_td.md",
